...
STARK_FOLDER = "data/2Q_chip/stark_shift/"

if __name__ == "__main__":
    filename = STARK_FOLDER + "stark_shift_data_0.npz"
    ...
    RO_FREQ = 7583.1547  # MHz
    RO_AMP = np.linspace(0.0025, 0.04, 25)
    # PROBE_DURATION = 2.5  # us
    RO_DURATION = 2.5

    DRIVE_FREQ = np.linspace(5550, 5650, 120)  # MHZ
    DRIVE_AMP = 0.007
    DRIVE_DURATION = 1
    ...
    plt.tight_layout()
    plt.savefig(STARK_FOLDER + "stark.png")
    plt.show()
